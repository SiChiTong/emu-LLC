...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_XTAL                                                                                 // set by target:EMULATOR
#define HSE_VALUE                                                             24000000                                                                                         // set by target:EMULATOR
#define LPTICKER_DELAY_TICKS                                                  0                                                                                                // set by target:EMULATOR
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:EMULATOR
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       ETHERNET                                                                                         // set by target:EMULATOR
...
#define STM32_D11_SPI_ETHERNET_PIN                                            PB_5                                                                                             // set by target:EMULATOR
// Macros
